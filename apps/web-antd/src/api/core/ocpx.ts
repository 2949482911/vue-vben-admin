...
import type {
  ...
  CreatePlatformCallbackRequest, EventSettlementItem, EventSettlementPageRequest,
  ...
  PlatformcallbackPageRequest, ReportAnalysisOcpxRequest, ReportAnalysisOcpxResponse,
...
class OcpxTaskApi extends BaseApi {
  ...
  // 获取分析数据
  fetchOcpxDataAnalysis(params: ReportAnalysisOcpxRequest) {
    return requestClient.post(this.getServiceUrl("report_analysis_ocpx"), params);
  }
}
