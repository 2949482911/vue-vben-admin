  ...
  },
  {
    ...
    cellRender: {
      name: 'CellTag', options: [
        ...
        {
          color: 'error',
          label: $t('media.account.loseEffective'),
          value: ConstantEnum.COMMON_DISABLE
        }
      ]
    },
  },
...
export const PlatformOptions = [
  {
    "label": `${$t('core.platform.kuaishou')}`,
    "value": "kuaishou"
  },
  {
    "label": `${$t('core.platform.douyin')}`,
    "value": "douyin"
  },
  {
    "label": `${$t('core.platform.bilibili')}`,
    "value": "bilibili"
  },
  {
