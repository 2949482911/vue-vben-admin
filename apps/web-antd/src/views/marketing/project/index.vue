...
import { Avatar, Button, Dropdown, Menu, MenuItem, Switch } from "ant-design-vue";
...
const gridOptions: VxeGridProps<ProjectItem> = {
  ...
  columns: [
    {
      field: "name",
      title: `${$t("marketing.project.columns.name")}`,
      width: "auto"
    },
    {
      field: "projectType",
    ...
    {
      field: "packageName",
      title: `${$t("marketing.project.columns.packageName")}`,
      width: "auto"
    },

    {
      field: "description",
      title: `${$t("marketing.project.columns.description")}`,
      width: "auto"
    },
    ...
    <Grid>
      ...
      <template #toolbar-tools>
        <Dropdown trigger="click" placement="bottom">
          ...
          <template #overlay>
            <Menu>
              <MenuItem @click="openBatchOptions('org')"> 修改部门</MenuItem>
              <MenuItem @click="openBatchOptions('creator')"> 修改创建人</MenuItem>
              <MenuItem @click="openBatchOptions('status')"> 修改状态</MenuItem>
              <MenuItem @click="batchDelete"> 批量删除</MenuItem>
            </Menu>
          </template>
        </Dropdown>
