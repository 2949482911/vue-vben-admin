 ...
 * vivo 2.0 的规则配置
 *
 * 新版 Marketing-API 只有「计划 / 广告」两级，因此隐藏广告组、创意层级
 */
export const vivoV2RuleConfiguration: RuleConfiguration = {
  project: {
    show: true,
    name: '计划',
    rules: '计划生成规则',
 ...
 * vivo 2.0 的规则选项
 */
export const vivoV2RuleOptions: RuleOptions = {
  projectRules: [
