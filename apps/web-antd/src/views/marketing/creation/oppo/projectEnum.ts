...
export function getExtensionLabel(value: any) {
  return findLabel(EXTENSION_SELECT, value);
}

export function getDayLimitLabel(value: any) {
  return findLabel(DAYLIMIT_SELECT, value);
}

export function getDeliveryModeLabel(value: any) {
  return findLabel(DELIVERMODE_SELECT, value);
}

export function getFlowLabel(value: any) {
  return findLabel(FLOW_SELECT, value);
}

export function getFlowSceneLabel(value: any) {
  return findLabel(FLOWSCENE_SELECT, value);
}

export function getDeepCvLabel(value: any) {
  return findLabel(DEEP_CV_SELECT, value);
}

export function getPageTypeLabel(value: any) {
  return findLabel(PAGE_TYPE_SELECT, value);
}

export function getSmartExpandLabel(value: any) {
  return findLabel(SMART_EXPAND_SELECT, value);
}

export function getDayLimitFlagLabel(value: any) {
  return findLabel(DAY_LIMIT_SELECT, value);
}

export function getTimeLimitLabel(value: any) {
  return findLabel(TIME_LIMIT_SELECT, value);
}

export function getQuickAppLabel(value: any) {
  return findLabel(OPPO_QUICK_APP_SELECT, value);
}

export function getQuickAppTypeLabel(value: any) {
  return findLabel(QUICK_APP_TYPE_SELECT, value);
}

export function getFreeOrderLabel(value: any) {
  return findLabel(OPPO_FREE_ORDER_SELECT, value);
}

export function getProductAdTypeLabel(value: any) {
  return findLabel(PRODUCT_AD_TYPE_SELECT, value);
}

export function getAdTypeLabel(value: any) {
  return findLabel(ADTYPE_SELECT, value);
}

export function getAppPageLabel(value: any) {
  return findLabel(APP_PAGE_SELECT, value);
}

export function getOptimizeSwitchLabel(value: any) {
  return findLabel(OPTIMIZE_SWITCH_SELECT, value);
}

export function getOptimizeTypeLabel(value: any) {
  return findLabel(OPTIMIZE_TYPE_SELECT, value);
}

export function getGlobalSpecIdLabel(value: any) {
  return findLabel(GLOBAL_SPECID_SELECT, value);
}

export function getBillingTypeLabel(value: any) {
  return findLabel(BILLINGTYPE_SELECT, value);
}

export function getMediaLabel(value: any) {
  return findLabel(MEDIA_SELECT, value);
}
...
export function getOcpcOptmTypeLabel(value: any) {
  return findLabel(OCPC_OPTM_TYPE_OPTIONS, value);
}
...
export function getDynamicCrLabel(value: any) {
  return findLabel(DYNAMIC_CR_OPTIONS, value);
}
