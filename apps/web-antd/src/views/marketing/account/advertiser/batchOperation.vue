...
import type { AdvertiserItem, OrgItem, UserItem } from "#/api/models";
import { accountLabelApi, advertiserApi, orgApi, projectApi, userApi } from "#/api";
...
const [Form, formApi] = useVbenForm({
  ...
  schema: [
    ...
    },
    {
      ...
      dependencies: {
        show: () => {
          return modalType.value === "creator";
        },
        triggerFields: ["orgId"],
