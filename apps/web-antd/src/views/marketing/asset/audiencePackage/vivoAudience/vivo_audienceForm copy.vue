    ...
    >
      <Form>
        <template #regionCodeList>
          <div>
            <RadioGroup
              v-model:value="regionSel"
              button-style="solid"
              @change="handleChange(regionSel, 'regionCodeList', regionArr)"
            >
        ...
        <template #sexList>
          <div class="flex flex-col gap-2">
            ...
            <div v-if="sexListType === '1'">
              <CheckboxGroup v-model:value="sexSelectedIds" :options="sexOptions" />
            </div>
          </div>
        </template>
        <template #ageList>
          <div class="flex flex-col gap-2">
            ...
            <div v-if="ageType === '1'">
              <CheckboxGroup v-model:value="ageListIds" :options="ageOptions" />
            </div>
          </div>
        </template>
        ...
        <template #interestSet>
          <div>
            <RadioGroup
              ...
              button-style="solid"
              @change="handleChange(interestSetType, 'interestSet', interestSetArr)"
            >
              <RadioButton :value="0">不限</RadioButton>
        ...
        <template #androidVersionSet>
          <div class="flex flex-col gap-2">
            <RadioGroup
              ...
              button-style="solid"
              @change="
                handleChange(androidVersionSetType, 'androidVersionSet', androidVersionSetIds)
              "
            >
              <RadioButton value="0">不限</RadioButton>
              <RadioButton value="1">设置</RadioButton>
        ...
        <template #phonePriceSet>
          <div class="flex flex-col gap-2">
            ...
            <div v-if="phonePriceSetType === '1'">
              <CheckboxGroup v-model:value="phonePriceSetIds" :options="phonePriceSetOptions" />
            </div>
          </div>
        </template>
        <template #phoneSeriesSet>
          <div class="flex flex-col gap-2">
            ...
            <div v-if="phoneSeriesSetType === '1'">
              <CheckboxGroup v-model:value="phoneSeriesSetIds" :options="phoneSeriesSetOptions" />
            </div>
          </div>
        </template>
        <template #networkOperatorSet>
          <div class="flex flex-col gap-2">
            <RadioGroup
              ...
              button-style="solid"
              @change="
                handleChange(networkOperatorSetType, 'networkOperatorSet', networkOperatorSetIds)
              "
            >
              <RadioButton value="0">不限</RadioButton>
              <RadioButton value="1">设置</RadioButton>
