<script setup lang="ts" name="CreateCrowd">
...
function getPlatformSchema(platform: string) {
  const schema: Array<FormSchema> = [
    ...
    },
    {
      component: "Input",
      fieldName: "crowdName",
      label: `${$t("media.crowd.columns.crowdName")}`,
      rules: 'required',
    },
    {
      component: "Textarea",
      fieldName: "crowdDesc",
      label: `${$t("media.crowd.columns.crowdDesc")}`,
      rules: 'required',
    },

    {
      component: "Textarea",
      fieldName: "tagCondition",
      label: `${$t("media.crowd.columns.tagCondition")}`,
      rules: 'required',
    },
  ]
  return schema;
