<script setup lang="ts" name="RedNoteOrderDetail">
import {useVbenModal} from '@vben/common-ui';
import {h, ref} from "vue";
import {$t} from "@vben/locales";
import {Card, Descriptions, Divider, Spin, Tag} from "ant-design-vue";
import type {OrderDetailRequest, RedNoteOrderItemDetail, RedNoteOrderSku} from "#/api/models";
...
const orderDetail = ref<RedNoteOrderItemDetail>();
...
const gridOptions: VxeGridProps<RedNoteOrderSku> = {
  border: true,
  columns: [
